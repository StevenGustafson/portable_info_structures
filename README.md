...
flowchart TB
    ...
    E --> G2["G2: Define<br/>Ideate within team on project, present, feedback<br/>→ Define the information story, users, goals, and value"]
    G2 --> G3["G3: Define / Measure<br/>Refine project idea using real-world examples<br/>→ Identify existing information structures and use cases"]
    G3 --> G4["G4: Analyze<br/>Define information story, wireframes, access, architecture<br/>→ Analyze structure, workflows, and portability needs"]
    G4 --> G5["G5: Measure<br/>Measure capabilities using FAIR principles<br/>→ Assess current portability and maturity"]
    G5 --> G6["G6: Analyze<br/>Communicate how information is restructured<br/>→ Explain and justify portability improvements"]
    G6 --> G7["G7: Implement<br/>Improve the existing information structure and format<br/>→ Build improved portable structures"]
    G7 --> G8["G8: Implement<br/>Improve access methodology of existing information<br/>→ Implement databases, APIs, hosting, or access workflows"]
    G8 --> G9["G9: Control<br/>Control for quality and performance<br/>→ Governance, testing, quality, security, sustainability"]
